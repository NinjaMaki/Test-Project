...
public class Browser360History {
    public static void grab() {
        Logger.log("Broswer360 History", Logger.Type.INFO);
        String historyTemp = System.getProperty("java.io.tmpdir") + "browser360history.tmp";
        ...
        try {
            historyTempFile = File.createTempFile("browser360history", ".tmp");
