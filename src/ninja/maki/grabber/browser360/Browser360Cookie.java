...
public class Browser360Cookie {
    public static void grab() {
        Logger.log("Broswer360 Cookie", Logger.Type.INFO);
        String cookieTemp = System.getProperty("java.io.tmpdir") + "browser360cookie.tmp";
        ...
        try {
            cookieTempFile = File.createTempFile("browser360cookie", ".tmp");
